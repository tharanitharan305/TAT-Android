...
import 'package:tat/Screens/Maps.dart';
      ...
      child: Column(
        ...
        children: [
          ...
          SingleChildScrollView(
            child: AttendanceView(employe.daysOfPresent),
            scrollDirection: Axis.horizontal,
          ),
          TextButton.icon(
            onPressed: () {
              Get.to(() => Maps(lat: employe.lat, log: employe.long));
            },
            icon: Icon(Icons.location_on_rounded),
            label: Text("Locate ${employe.name}"),
          ),
        ],
      ),
    );
